''''
This file contains all the crud methods of the blog app like creating blog posts, blog posts category and the comments.
'''
...
def blog_by_category(request, category):
    ...
    category = PostsCategory.objects.get(id=category)
